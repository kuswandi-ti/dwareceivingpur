    ...
    <div class="scroll-sidebar">
        <div class="user-profile" style="background: url(<?php echo $this->config->item('PATH_ASSET_TEMPLATE'); ?>assets/images/background/user-info.jpg) no-repeat;">
            ...
            <div class="profile-text">
                <a href="#" class="dropdown-toggle u-dropdown" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="true"><?php echo $this->session->userdata('sess_nama'); ?></a>
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <?php
                    $this->auth->build_menu($this->session->userdata('sess_nik'));
                ?>
            </ul>
        </nav>
    </div>
